...
async function main() {
    const UUID = await getVariableValue('UUID', 'f024e3df-9c7b-4460-b35e-27e9661ddfe2); // 为保证安全隐蔽，建议留空，可在Node.js界面下的环境变量添加处（Environment variables）,点击ADD VARIABLE，修改变量
    ...
    const DOMAIN = await getVariableValue('DOMAIN', 'private-656953225398.europe-west4.run.app');// 为保证安全隐蔽，建议留空，可在Node.js界面下的环境变量添加处（Environment variables）,点击ADD VARIABLE，修改变量
